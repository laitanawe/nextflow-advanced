...
2. To ensure that your present working directory is `~/Desktop/nfdemo`, you can use: `cd ~/Desktop/nfdemo`, then download <a href="https://laitanawe.github.io/nextflow-advanced/data/nextflow-adv-lesson.tar.gz">nextflow-adv-lesson.tar.gz</a>
